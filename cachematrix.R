...
## functions do
#These functions can be used to compute the inverse of a matrix and cache the result so that it can be used
#at a later time, instead of re-calculating the inverse again
